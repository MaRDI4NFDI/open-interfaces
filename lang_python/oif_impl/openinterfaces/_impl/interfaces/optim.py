...
class OptimInterface(abc.ABC):
    @abc.abstractmethod
    def set_initial_guess(self, x0: np.ndarray) -> Union[int, None]:
        """Set initial guess for minimization."""

    @abc.abstractmethod
    def set_objective_fn(self, objective_fn: Callable) -> Union[int, None]:
        """Specify objective function f."""
