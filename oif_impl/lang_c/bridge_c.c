...
ImplInfo * load_impl(const char *impl_details, size_t version_major, size_t version_minor)
{
    (void)version_major;
    (void)version_minor;
...
unload_impl(ImplInfo *impl_info_)
{
    ...
    void *(*free_fn)(void *) = dlsym(impl_info->impl_lib, free_fn_name);
