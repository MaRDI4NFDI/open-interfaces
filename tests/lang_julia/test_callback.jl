...
@testset "check that callback wrapper can be dynamic" begin
    ...
    axpy_with_context_f64_arrf64_arrf64__ret_i32_fn =
        Libdl.dlsym(lib, :axpy_with_context_f64_arrf64_arrf64__ret_i32)

    w_f64_f64__ret_f64 = make_wrapper_over_c_callback(
        add_two_doubles_fn,
    ...
    axpy_f64_arrf64_arrf64__ret_i32_wrapper = make_wrapper_over_c_callback(
        ...
        (OIF_TYPE_F64, OIF_TYPE_ARRAY_F64, OIF_TYPE_ARRAY_F64),
        OIF_TYPE_I32,
    )
    alpha = 2.3
    x = [1.2, 3.4, 5.6]
    ...
    axpy_with_context_f64_arrf64_arrf64__ret_i32_wrapper = make_wrapper_over_c_callback(
        axpy_with_context_f64_arrf64_arrf64__ret_i32_fn,
        (OIF_TYPE_F64, OIF_TYPE_ARRAY_F64, OIF_TYPE_ARRAY_F64, OIF_TYPE_USER_DATA),
        OIF_TYPE_I32,
    )
    alpha = 2.3
    x = [1.2, 3.4, 5.6]
