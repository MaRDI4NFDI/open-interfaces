# Copyright (C) 1995-2019, Rene Brun and Fons Rademakers. All rights reserved.
#
# For the licensing terms see $ROOTSYS/LICENSE. For the list of contributors see
# $ROOTSYS/README/CREDITS.

# CMake module to find R - Try to find R Once done, this will define
#
# R_FOUND - system has R R_INCLUDE_DIRS - the R include directories R_LIBRARIES
# - link these to use R R_ROOT_DIR - As reported by R Autor: Omar Andres Zapata
# Mesa 31/05/2013
...
foreach(_cpt ${R_FIND_COMPONENTS})
  execute_process(
    COMMAND echo "cat(find.package('${_cpt}'))"
  ...
  find_library(R_${_cpt}_LIBRARY lib${_cpt}.so lib${_cpt}.dylib
               HINTS ${_cpt_path}/lib)
  if(R_${_cpt}_LIBRARY)
...
# Handle the QUIETLY and REQUIRED arguments and set R_FOUND to TRUE if all
# listed variables are TRUE
include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(
  R HANDLE_COMPONENTS REQUIRED_VARS R_EXECUTABLE R_INCLUDE_DIR R_LIBRARY)
