...
/// language-specific implementation of ::oif_connector_init
int oif_lang_init(void);
/// language-specific implementation of ::oif_connector_eval_expression
int oif_lang_eval_expression(const char *str);
/// language-specific implementation of ::oif_connector_deinit
int oif_lang_deinit(void);
/// language-specific implementation of ::oif_connector_solve
